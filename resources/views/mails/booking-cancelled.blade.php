...
<body>
    <div class="container">
        ...
        <p>Your booking has been cancelled successfully. We're sorry to see you go and hope to serve you again in the future.</p>
        ...
        <div class="section-title">📅 Cancelled Booking Details</div>
            ...
            <!-- Important Notes -->
            <div class="note">
                <strong>ℹ️ Any applicable refunds will be processed according to our cancellation policy.</strong>
            </div>
            ...
            <p>If this cancellation was made by mistake or you would like to create a new booking, please contact us:</p>
